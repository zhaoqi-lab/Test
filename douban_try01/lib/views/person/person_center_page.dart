    ...
    return Row(
      ...
      children: <Widget>[
        CircleAvatar(
          ...
          child: Image.asset(Constant.ASSETS_IMG + 'ic_tab_profile_normal.png'),
        ),
        Expanded(
          child: Padding(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        ...
                        IconButton(icon: Icon(Icons.chevron_right,color: Colors.black,), onPressed: (){
                          print('书影音档案');
                        }),
                      ],
                    ),
